...
export const JournalMoodAnalytics = ({ entries }) => {
  const analytics = useMemo(() => {
    ...
    const totalMoodPoints = entriesWithMood.reduce((sum, e) => sum + (e.mood || 0), 0);
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      const dayAvgMood = dayEntries.length > 0
    ...
    // Most common mood
    const mostCommonMood = Object.entries(moodDist)
      .sort(([,a], [,b]) => b - a)[0]?.[0];
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[5, 4, 3, 2, 1].map(mood => {
              ...
              const percentage = analytics.totalWithMood > 0 
