  ...
  return (
    <AnimatedPage>
      <div className="p-4 md:p-8 space-y-4 md:space-y-6">
        {/* Header */}
        <div>
          <h2 className="type-h1 mb-2">pomodoro timer.</h2>
            ...
            <div className="p-4 md:p-8 space-y-4 md:space-y-6">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <svg className="w-56 h-56 md:w-72 md:h-72 -rotate-90">
                  ...
                  <circle
                    ...
                    strokeDashoffset={`${
                      2 * Math.PI * 104 * (1 - percentage / 100)
                    }`}
                    strokeLinecap="round"
                  />
                  <circle
                  ...
                  <circle
                    ...
                    strokeDashoffset={`${
                      2 * Math.PI * 136 * (1 - percentage / 100)
                    }`}
                    strokeLinecap="round"
                  />
                </svg>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="type-body text-(--text-muted) mt-2 md:mt-3">
                ...
                <div className="space-y-2">
                  {!showActivityInput && !currentActivity ? (
                    <button
                      ...
                      className="w-full py-2 px-3 md:px-4 type-body text-(--text-muted) hover:text-(--text-main) border border-dashed border-(--border-color) hover:border-(--text-main) transition-colors"
                    >
                    ...
                    <div className="flex items-center justify-between py-2 px-3 md:px-4 bg-(--bg-color) border border-(--border-color)">
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        ...
                        />
                        <span className="type-body text-(--text-main) truncate">
                          {currentActivity}
                        </span>
                      </div>
                      <button
              ...
              <div className="flex gap-2 justify-center pt-4 border-t border-dashed border-(--border-color)">
                <button
                  ...
                  className={`px-4 py-2 type-body transition-colors ${
                    sessionType === "focus"
          ...
          <div className="space-y-6">
            ...
            <Card>
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="type-label text-(--text-muted)">hari ini</h3>
                </div>

                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center">
                    <div className="type-h2 text-(--text-main)">
                      {todaySessions.length}
                    </div>
                    <div className="type-caption text-(--text-muted) mt-1">
                      sesi selesai
                    </div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="type-h2 text-(--accent)">
                      {sessionCount}
                    </div>
                    <div className="type-caption text-(--text-muted) mt-1">
                      streak
            ...
            <Card>
              <div className="p-6 text-center space-y-3">
                <p className="type-h2 italic text-(--text-main)">
                  "fokus dalam adalah superpower
                  <br />
                  di era distraksi."
                </p>
