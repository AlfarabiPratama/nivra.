...
export const JournalView = () => {
  ...
  const handleAddEntry = () => {
    if (content.trim()) {
      ...
      addToast("entri jurnal tersimpan", "success");
      addToast("entri jurnal tersimpan âœï¸", "success");
      setContent("");
  ...
  return (
    <AnimatedPage>
      <div className="p-4 md:p-8 space-y-4 md:space-y-6 max-w-4xl">
        {/* Header */}
        <div>
          <h2 className="type-h1 mb-2">jurnal.</h2>
          <p className="type-body text-(--text-muted) lowercase">
        ...
        {entries.length > 0 && (
          <Card>
            <div className="space-y-3">
              <h4 className="type-label">Filter Entri</h4>
              ...
              <div className="flex gap-2 flex-wrap">
                <button
                  ...
                  className={clsx(
                    "px-3 py-1 type-caption border transition-all",
                    !filterMood
        ...
        <Card variant="dashed">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="type-label text-(text-main)">
              ...
              <div className="flex gap-2">
                {moodOptions.map((mood) => (
                  <button
                    ...
                    className={clsx(
                      "flex-1 p-2 md:p-3 border transition-all duration-200 cursor-pointer",
                      "hover:scale-105 hover:shadow-lg hover:bg-(--accent)/20 hover:border-(--accent)",
                      "active:scale-95",
                  ...
                  >
                    <span
                      className={clsx(
                        "text-xl md:text-2xl block transition-transform duration-200",
        ...
        <div className="space-y-4">
          ...
          {filteredEntries.length === 0 ? (
            <EmptyState
              type="journal"
              customMessage={
                entries.length > 0 ? "tidak ada entri sesuai filter" : null
              }
              icon={
                <Feather size={48} className="text-(text-muted) opacity-50" />
              }
            />
          ) : (
